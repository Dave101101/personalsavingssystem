...
?>
<aside class="sidebar">
    <div class="logo">FIRST GROUPS</div>
    ...
    <nav>
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="investments.php" class="nav-link <?php echo $currentPage === 'investments' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="circles.php" class="nav-link <?php echo $currentPage === 'circles' ? 'active' : ''; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Circles
                </a>
            </li>
            <li class="nav-item">
                <a href="bills.php" class="nav-link <?php echo $currentPage === 'bills' ? 'active' : ''; ?>">
